...
![Perpetual Logo](https://github.com/perpetual-ml/perpetual/raw/main/resources/perp_logo.png)
...
Documentation for the Python API can be found in [the Python API documentation](https://perpetual-ml.github.io/perpetual) and for the Rust API in [the Rust API documentation](https://docs.rs/perpetual/latest/perpetual/).
